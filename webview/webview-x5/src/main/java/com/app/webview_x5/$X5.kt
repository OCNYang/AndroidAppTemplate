...
object X5 {
    ...
    fun init(appContext: Application, openDownload: Boolean = true) {
        dex2oat()
    ...
    fun getWebViewCrashInfo(appContext: Application): String {
        return com.tencent.smtt.sdk.WebView.getCrashExtraMessage(appContext)
    }
