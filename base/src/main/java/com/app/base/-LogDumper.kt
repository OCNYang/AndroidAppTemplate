...
class LogcatHelper private constructor(
    ...
    companion object {
        private const val MAX_FILE_SIZE = 524288L // 0.5MB
        private const val MAX_FOLDER_SIZE = 5242880L // 5MB
    }
...
//                val logcatDir = File(logcatPath)
//                if (logcatDir.isDirectory) {
//                    val listFiles = logcatDir.listFiles()
